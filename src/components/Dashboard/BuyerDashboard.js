  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="ml-1 mr-1 justify-evenly  flex md:flex-row flex-col ">
          <div className="w-full   m-2 p-8">
            <img className="  " src="../podcast1.png" alt="logo" />
          </div>
          <div className="w-full   m-2 p-8">
            <img className="  " src="../podcast2.png" alt="logo" />
      ...
      <section>
        ...
        <div className=" ml-1 mr-1 flex md:flex-row flex-col justify-evenly  ">
          <div className="w-full  m-2 p-8">
            <img className="  " src="../podcast1.png" alt="logo" />
          </div>
          <div className="w-full  m-2 p-8 ">
      ...
      <section>
        <div className="flex md:flex-row font-semibold justify-start text-black pl-16 pt-7 text-2xl">
          Hindi Podcast!
        </div>
        <div className="ml-1 mr-1 flex md:flex-row flex-col justify-evenly  ">
          <div className="w-full  m-2 p-8">
